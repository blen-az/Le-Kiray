...
const AgentActivationPage: React.FC = () => {
 ...
 // Now migrate the agent document to the true Firebase UID
 console.log('Migrating agent document to Firebase UID...');
 ...
 const agentData = oldDocSnap.data();
 ...
 throw new Error("Original agent profile not found during activation.");
 }
