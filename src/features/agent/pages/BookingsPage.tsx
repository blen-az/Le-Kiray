...
const BookingsPage: React.FC = () => {
 ...
 <p className="text-slate-900 font-medium">{booking.startDate} → {booking.endDate}</p>
 </div>
 <div>
 <p className="text-slate-500 text-xs uppercase tracking-widest">Total</p>
 <p className="text-indigo-600 font-bold">{booking.totalPrice.toLocaleString()} ETB</p>
 </div>
 </div>
 </div>
 ))
 ...
 <h3 className="text-lg font-black text-slate-900 mb-6">Booking Details</h3>
 
 <div className="space-y-4 mb-6">
 <div>
 <p className="text-xs text-slate-500 uppercase tracking-widest mb-1">Vehicle</p>
 <p className="text-slate-900 font-bold">{selectedBooking.listingName}</p>
 </div>
 <div>
 <p className="text-xs text-slate-500 uppercase tracking-widest mb-1">Customer</p>
 <p className="text-slate-900 font-bold">{selectedBooking.consumerName}</p>
 <p className="text-sm text-slate-500 ">{selectedBooking.consumerEmail}</p>
 <p className="text-sm text-slate-500 ">{selectedBooking.consumerPhone}</p>
 </div>
 <div className="grid grid-cols-2 gap-4">
 <div>
 <p className="text-xs text-slate-500 uppercase tracking-widest mb-1">Start</p>
 <p className="text-slate-900 font-medium">{selectedBooking.startDate}</p>
 </div>
 <div>
 <p className="text-xs text-slate-500 uppercase tracking-widest mb-1">End</p>
 <p className="text-slate-900 font-medium">{selectedBooking.endDate}</p>
 </div>
 </div>
 <div>
 <p className="text-xs text-slate-500 uppercase tracking-widest mb-1">Total Price</p>
 <p className="text-2xl font-black text-indigo-600 ">{selectedBooking.totalPrice.toLocaleString()} ETB</p>
 </div>
 </div>
