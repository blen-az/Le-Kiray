...
const AnalyticsPage: React.FC = () => {
 ...
 <p className="text-3xl font-black text-white">{stats.totalRevenue.toLocaleString()}<span className="text-lg"> ETB</span></p>
 </div>
 ...
 <span className="text-xs font-bold text-slate-500 ">Revenue (ETB)</span>
 </div>
 </div>
 <div className="h-72">
