    ...
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          <li><a href="#" className="hover:text-brand-main transition-colors">Excavators</a></li>
          <li><a href="#" className="hover:text-brand-main transition-colors">Bulldozers</a></li>
          <li><a href="#" className="hover:text-brand-main transition-colors">Cranes & Lifting</a></li>
          <li><a href="#" className="hover:text-brand-main transition-colors">Site Transport</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          <li><a href="#" className="hover:text-brand-main transition-colors">Terms of Service</a></li>
          <li><a href="#" className="hover:text-brand-main transition-colors">Privacy Policy</a></li>
          <li><a href="#" className="hover:text-brand-main transition-colors">Agent Subscriptions</a></li>
          <li><a href="#" className="hover:text-brand-main transition-colors">Contact Support</a></li>
        </ul>
      </div>
    </div>
